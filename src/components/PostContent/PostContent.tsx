...
const customComponent = {
  p({ ...props }) {
    ...
    if (isImage) {
      return <PostContentImg src={props.node.children[0].properties.src} alt={props.node.children[0].properties.alt} />;
    }
  ...
  img({ ...props }) {
    return <PostContentImg src={props.src} alt={props.alt} />;
  },
  ...
  return (
    <Container>
      <div className="thumbnail">
        <Image src={thumbnailImg!} fill sizes="100%" placeholder="blur" loading="lazy" alt={`${title!}-thumbnail`} />
      </div>
      <ReactMarkdown
