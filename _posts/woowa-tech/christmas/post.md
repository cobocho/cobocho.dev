...
![내가 요구사항을 조금씩 설정한건 추진력을 얻기 위함이었다](2.png)
...
![코드를 보기 전에 간단하게 도메인을 이미지화 시켜보았다](3.png)
